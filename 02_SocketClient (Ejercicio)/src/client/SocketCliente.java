...
public class SocketCliente {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("CLIENTE: Introduzca la operecion que desea realizar (1-Sumar, 2-Restar, 3-Multiplicar 4-Dividir)");
			String operacion = sc.nextLine();
			
			String operandos = numero1 + "-" + numero2 + "-" + operacion;//3-4-1(suma)
			salida.println(operandos);//3-4-1(suma)
